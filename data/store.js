...
function seedData() {
  ...
  db.product_units = [
    ...
    },
    {
      ...
      can_restock: false,
      can_sell: true,
      approx_base_qty_per_piece: 0.15,
      notes: "~0.15 kg/piece",
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    },
  ...
  db.sales = [
    // ── Today ──
    {
      ...
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(0, 7, 30),
      notes: null,
      created_by: 1,
      created_at: daysAgo(0, 7, 30),
      updated_at: daysAgo(0, 7, 30),
    },
    {
      id: 2,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(0, 9, 12),
      notes: null,
      created_by: 1,
    ...
    },
    {
      ...
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(0, 11, 45),
      notes: null,
      created_by: 1,
      created_at: daysAgo(0, 11, 45),
      updated_at: daysAgo(0, 11, 45),
    },
    {
      id: 4,
      customer_id: 1,
      payment_type_id: 2,
      sale_date: daysAgo(0, 14, 30),
      notes: null,
      created_by: 1,
    ...
    // ── Yesterday ──
    {
      ...
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(1, 8, 5),
      notes: null,
      created_by: 1,
      created_at: daysAgo(1, 8, 5),
      updated_at: daysAgo(1, 8, 5),
    },
    {
      id: 6,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(1, 12, 20),
      notes: null,
      created_by: 1,
    ...
    },
    {
      ...
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(1, 16, 50),
      notes: null,
      created_by: 1,
      created_at: daysAgo(1, 16, 50),
      updated_at: daysAgo(1, 16, 50),
    },
    // ── 2 days ago ──
    {
      id: 8,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(2, 9, 0),
      notes: null,
      created_by: 1,
      created_at: daysAgo(2, 9, 0),
      updated_at: daysAgo(2, 9, 0),
    },
    {
      id: 9,
      customer_id: 1,
      payment_type_id: 2,
      sale_date: daysAgo(2, 15, 10),
      notes: null,
      created_by: 1,
      created_at: daysAgo(2, 15, 10),
      updated_at: daysAgo(2, 15, 10),
    },
    // ── 3 days ago ──
    {
      id: 10,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(3, 8, 40),
      notes: null,
      created_by: 1,
      created_at: daysAgo(3, 8, 40),
      updated_at: daysAgo(3, 8, 40),
    },
    {
      id: 11,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(3, 17, 5),
      notes: null,
      created_by: 1,
      created_at: daysAgo(3, 17, 5),
      updated_at: daysAgo(3, 17, 5),
    },
    // ── 5 days ago ──
    {
      id: 12,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(5, 10, 30),
      notes: null,
      created_by: 1,
      created_at: daysAgo(5, 10, 30),
      updated_at: daysAgo(5, 10, 30),
    },
    {
      id: 13,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(5, 14, 0),
      notes: null,
      created_by: 1,
    ...
    // ── 8 days ago (last week) ──
    {
      ...
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(8, 9, 20),
      notes: null,
      created_by: 1,
      created_at: daysAgo(8, 9, 20),
      updated_at: daysAgo(8, 9, 20),
    },
    {
      id: 15,
      customer_id: 1,
      payment_type_id: 2,
      sale_date: daysAgo(8, 13, 45),
      notes: null,
      created_by: 1,
    ...
    },
    {
      ...
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(12, 15, 30),
      notes: null,
      created_by: 1,
      created_at: daysAgo(12, 15, 30),
      updated_at: daysAgo(12, 15, 30),
    },
    // ── 18 days ago ──
    {
      id: 18,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(18, 8, 15),
      notes: null,
      created_by: 1,
      created_at: daysAgo(18, 8, 15),
      updated_at: daysAgo(18, 8, 15),
    },
    {
      id: 19,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(18, 16, 40),
      notes: null,
      created_by: 1,
      created_at: daysAgo(18, 16, 40),
      updated_at: daysAgo(18, 16, 40),
    },
    // ── 25 days ago ──
    {
      id: 20,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(25, 10, 0),
      notes: null,
      created_by: 1,
      created_at: daysAgo(25, 10, 0),
      updated_at: daysAgo(25, 10, 0),
    },
    {
      id: 21,
      customer_id: 1,
      payment_type_id: 2,
      sale_date: daysAgo(25, 14, 20),
      notes: null,
      created_by: 1,
      created_at: daysAgo(25, 14, 20),
      updated_at: daysAgo(25, 14, 20),
    },
    // ── 35 days ago (last month) ──
    {
      ...
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(35, 9, 0),
      notes: null,
      created_by: 1,
      created_at: daysAgo(35, 9, 0),
      updated_at: daysAgo(35, 9, 0),
    },
    {
      id: 23,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(35, 13, 10),
      notes: null,
      created_by: 1,
      created_at: daysAgo(35, 13, 10),
      updated_at: daysAgo(35, 13, 10),
    },
    // ── 45 days ago ──
    {
      id: 24,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(45, 11, 30),
      notes: null,
      created_by: 1,
      created_at: daysAgo(45, 11, 30),
      updated_at: daysAgo(45, 11, 30),
    },
    {
      id: 25,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(45, 17, 0),
      notes: null,
      created_by: 1,
      created_at: daysAgo(45, 17, 0),
      updated_at: daysAgo(45, 17, 0),
    },
    // ── 60 days ago ──
    {
      id: 26,
      customer_id: null,
      payment_type_id: 1,
      sale_date: daysAgo(60, 8, 0),
      notes: null,
      created_by: 1,
      created_at: daysAgo(60, 8, 0),
      updated_at: daysAgo(60, 8, 0),
    },
    {
      id: 27,
      customer_id: 1,
      payment_type_id: 2,
      sale_date: daysAgo(60, 14, 30),
      notes: null,
      created_by: 1,
      created_at: daysAgo(60, 14, 30),
      updated_at: daysAgo(60, 14, 30),
    },
  ];
  ...
  db.sale_items = [
    ...
    // Sale 5 — yesterday: Cooking Oil + Sugar
    {
      ...
      weight_per_piece_kg: null,
      created_at: daysAgo(1, 8, 5),
      _product_name: "Cooking Oil",
      _emoji: "🫙",
      _unit_label: "1/2 (250mL)",
      _base_qty: 500,
    },
    {
      id: 11,
    ...
    },
    {
      ...
      manual_price_reason: "Loyalty discount",
      approved_by: null,
      weight_per_piece_kg: null,
      created_at: daysAgo(1, 12, 20),
      _product_name: "Beer",
    ...
    },
    {
      ...
      weight_per_piece_kg: null,
      created_at: daysAgo(2, 15, 10),
      _product_name: "Butane",
      _emoji: "🛢️",
      _unit_label: "canister",
      _base_qty: 2,
    },
  ...
  db.credit = [
    ...
    },
    {
      ...
      sale_id: 21,
      customer_id: 1,
      amount_owed: 1043.0, // 2×390 + 6×22 + 3×55
      amount_paid: 500.0,
      due_date: (() => {
        const d = new Date(now);
    ...
    },
    {
      ...
      sale_id: 27,
      customer_id: 1,
      amount_owed: 1590.0, // 3×390 + 4×55 + 40×5
      amount_paid: 1590.0,
      due_date: (() => {
        const d = new Date(now);
